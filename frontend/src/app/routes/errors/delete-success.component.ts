...
@Component({
  template: `
    <div class="state-page media-page-shell">
      <div class="state-card">
        <span class="state-card__eyebrow">Deleted</span>
        <h1>内容已成功删除</h1>
        <p>该图片或视频已从系统中移除。感谢使用 Picsur。</p>
        <a routerLink="/">返回首页</a>
      </div>
    </div>
  `,
  styles: [
    `
      ...
      .state-card__eyebrow { display:inline-flex; margin-bottom:12px; padding:6px 12px; border-radius:var(--radius-pill); background:rgba(232,248,238,0.82); border:1px solid rgba(71,170,111,0.22); color:#2c8a56; font-size:.76rem; font-weight:800; letter-spacing:.12em; }
